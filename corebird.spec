%global gitrev de305e8
%global timestamp 201402101407

Name:           corebird
Version:        0.6.1
Release:        %{timestamp}git%{gitrev}%{?dist}
...
# git archive master --prefix=corebird-$version/| gzip >corebird-$version-$date-$githash.tar.gz
Source0:        %{name}-%{version}-%{timestamp}-%{gitrev}.tar.gz
